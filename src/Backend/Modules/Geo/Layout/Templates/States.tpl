...
<div class="row fork-module-heading">
  <div class="col-md-12">
    <h2>{$lblStates|sprintf:{$country.locale.name}|ucfirst}</h2>
    <div class="btn-toolbar pull-right">
      <div class="btn-group" role="group">
        {option:showGeoAddState}
        <a href="{$var|geturl:'add_state':null:'&country_id={$country.id}'}" class="btn btn-default" title="{$lblAddState|ucfirst}">
...
<div class="row fork-module-content">
  <div class="col-md-12">
    {option:dgStates}
    <form action="{$var|geturl:'mass_action_states'}" method="get" class="forkForms">
      {$dgStates}
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>{$msgConfirmMassStatesDelete}</p>
            </div>
